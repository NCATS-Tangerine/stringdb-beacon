...
class DataType(Model):
    ...
    def __init__(self, id: str=None, idmap: str=None, frequency: int=None):
        ...
        :type id: str
        :param idmap: The idmap of this DataType.
        :type idmap: str
        :param frequency: The frequency of this DataType.
        :type frequency: int
        """
        self.swagger_types = {
            'id': str,
    ...
    def idmap(self) -> str:
        """
        Gets the idmap of this DataType.
        The URL to execute the exactmatches API call on the id

        :return: The idmap of this DataType.
        :rtype: str
        """
        return self._idmap
    ...
    def idmap(self, idmap: str):
        """
        Sets the idmap of this DataType.
        The URL to execute the exactmatches API call on the id
    ...
    def frequency(self) -> int:
        """
        Gets the frequency of this DataType.
        the number of instances of the specified type 

        :return: The frequency of this DataType.
        :rtype: int
        """
    ...
    def frequency(self, frequency: int):
        """
        Sets the frequency of this DataType.
        the number of instances of the specified type 
